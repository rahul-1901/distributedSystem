...
- **Background job queues** — an asynchronous queue for work that doesn't need to block the request/response cycle (e.g., media processing, notification delivery).
