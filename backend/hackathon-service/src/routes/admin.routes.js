...
router.delete("/hackathons/:hackathonId/judges/:judgeId", adminAuth, removeJudge);
router.get("/judges/assigned-hackathons", adminAuth, getAssignedHackathons);

router.get("/judges/hackathons/:hackathonId/submissions",adminAuth, getHackathonSubmissionsForJudge);
router.get("/judges/submissions/:submissionId", adminAuth, getSubmissionDetailsForJudge);
router.post("/judges/submissions/:submissionId/review", adminAuth, reviewSubmission);
router.get("/judges/submissions/:submissionId/reviews", adminAuth,getSubmissionReviews);
